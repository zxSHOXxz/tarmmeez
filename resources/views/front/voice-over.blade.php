...
@section('title', 'Voice Over -' . config('app.name'))
...
<section class="title-page" style="z-index: 1;">
  <div class="container">
      <div class="row">
          <h2>{{ __("index.Content writing and voiceover") }}</h2>
      </div>
  </div>
</section>
...
<section class="voice">
  <div class="container d-flex flex-wrap">
    <div class="left col-12 col-sm-12 col-md-12 col-lg-6">
      <img src="{{ asset('front/image/pexels-photo-10415146 1.png') }}" alt="" width="100%" height="100%">
    </div>
...
<section class="how-do" style="padding: 60px 0;">
  <div class="container d-flex flex-wrap">
    ...
    <div class="right col-12 col-sm-12 col-md-12 col-lg-6 d-flex align-items-center">
      <img src="{{ asset('front/image/Podcast.png') }}" alt="" width="100%">
    </div>
  </div>
</section>

<section class="programs" style="padding: 50px 0;">
  <div class="container">
    ...
    <div class="cont-programs">
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="{{ asset('front/image/Rectangle.png') }}" class="card-img-top" alt="...">
        </div>
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="{{ asset('front/image/Adobe Audition.png') }}" class="card-img-top" alt="...">
        </div>
        <div class="card-body">
...
<div class="container">
  <img src="{{ asset('front/image/Rectangle 241.png') }}" alt="" class="col-12 col-sm-12 col-md-12 col-lg-12">
</div>
