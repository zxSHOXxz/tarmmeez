...
@section('title', 'Online Store -' . config('app.name'))
...
<section class="title-page" style="z-index: 1;">
  <div class="container">
      <div class="row">
          <h2>{{ __("services.Online store design") }}</h2>
      </div>
  </div>
</section>
...
<section class="voice">
  <div class="container d-flex flex-wrap">
    <div class="left col-12 col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center">
      <img src="{{ asset('front/image/online shopping.png') }}" alt="" width="50%" height="fit-content">
    </div>
...
<section class="engine-card">
  <div class="container ">
    <div class="card d-flex flex-row flex-wrap col-12">
      ...
      <span class="col-12 col-sm-6 col-md-6 col-lg-3">
        <div class="img-down">
...
<section class="Featured">
    <div class="featured-link">
        <div class="title">
            <h1>{{__("index.Our Featured Work")}}</h1>

            <div class="nav-Featured d-flex justify-content-center">
                    <li class="featured-item">
                      <a class="featured-link active" aria-current="page" href="#">{{ __("index.Website") }}</a>
                    </li>
                    <li class="featured-item">
                      <a class="featured-link" href="#">{{ __("index.Application") }}</a>
                    </li>
                    <li class="featured-item">
                      <a class="featured-link" href="">{{ __("index.Graphic design") }}</a>
                    </li>
            </div>
        </div>
    </div>
    <div class="Featured-cont">
            ...
            <div class="services-slider">
                <div>
                    <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                  <p class="card-text">{{ __("index.Some quick example text to build on the card title and make up the bulk of the card's content.") }}</p>
                                </div>
                            </div>
                        </div>
                <div>
        ...
        <a class="featured-btn" href="{{ route('index-business-identity') }}">{{ __("index.See more") }}</a>
    </div>
</section>
    ...
    <div class="cont-programs">
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <p class="card-text">{{ __("services.We are always excited to hear about great ideas and help turn them into a successful projectWe are always") }} </p>
