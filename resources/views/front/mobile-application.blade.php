...
<section class="title-page" style="z-index: 1;">
  <div class="container">
      <div class="row">
          <h2>{{ __("services.Mobile application design") }}</h2>
      </div>
  </div>
</section>
...
<section class="voice">
  <div class="container d-flex flex-wrap">
    <div class="left col-12 col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center">
      <img src="{{ asset('front/image/pexels-photo-10415146 1 (1).png') }}" alt="" width="100%" height="fit-content">
    </div>
...
<section class="how-do" style="padding: 60px 0;">
    <div class="container d-flex flex-wrap justify-content-center">
      ...
      <div class="right col-12 col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center align-items-center">
        <img src="{{ asset('front/image/Mobile app with a taxi route.png') }}" alt="" width="100%">
      </div>
    </div>
  </section>
            ...
            <div>
                <div class="card" style="width: 18rem;">
                    <div class="card-header" style="padding: 20px 10px;">
                        <img src="{{ asset('front/image/Group 11103.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                      <h5 class="card-title">Web site for Mushtaha Furnture</h5>
                      <p class="card-text">Lorem ipsum dolor sit amet,
                        consetetur sadipscing elitr, sed diam
                        nonumy eirmod tempor invidunt ut </p>
                      <div class="con-btn">
